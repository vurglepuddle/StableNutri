...
class TDEECalc {
  ...
  /// Male reference result for a given PAL value.
  ///
  /// p. 204, verbatim:
  ...
  /// costs a non-sedentary user 109-489 kcal/day (upstream #987); the brackets
  /// are the whole content of this expression, so keep them. See
  ...
  /// Female reference result for a given PAL value. See [_iom2005MaleKcal] for
  /// the bracket placement this shares.
  ///
  /// p. 204, verbatim:
