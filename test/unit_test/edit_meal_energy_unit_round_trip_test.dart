...
void main() {
  group(
    'edit-meal manual energy entry, kJ ↔ kcal round trip (#177 follow-up)',
    () {
      ...
      test(
        'a 250 kcal stored value displays as ≈ 1046.0 kJ when kJ is active',
        () {
      ...
      test(
        'round-trip kJ → stored kcal → kJ display for typical daily-goal values',
        () {
