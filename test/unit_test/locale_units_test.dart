...
void main() {
  group('countryCodeFromLocale', () {
    test('reads the country from the common locale spellings', () {
      ...
      expect(countryCodeFromLocale('en_Latn_US'), 'US');
      expect(countryCodeFromLocale('zh-Hant-TW'), 'TW');
      expect(countryCodeFromLocale('de_DE@euro'), 'DE');
    });
    ...
    test('returns null when there is no country segment', () {
      ...
      expect(countryCodeFromLocale('zh_Hant'), isNull);
      expect(countryCodeFromLocale('en_USA'), isNull);
      expect(countryCodeFromLocale('en_u_rg_uszzzz'), isNull);
    });
  });
