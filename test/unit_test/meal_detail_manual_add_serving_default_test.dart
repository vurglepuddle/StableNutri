...
void main() {
  group('Meal detail — manual-add default unit (issue #34)', () {
    test(
      ...
      () async {
        ...
        // What makes this work is that the 32 g is readable out of the
        // text. Without it the unit would be "serving" while nothing
  ...
  group('a serving the app cannot scale', () {
